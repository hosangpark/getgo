...
class Api {
  constructor() {
    ...
    this.state = {
      ...
      siteUrl: 'https://getgoapi.dmonster.kr/app/api',
      imageUrl: 'https://getgoapi.dmonster.kr/uploads/',
      // socketUrl: 'https://getgoapi.dmonster.kr/socket.io/',
      socketUrl: 'https://getgoapi.dmonster.kr/',
