        ...
        return(
          ...
          {item.ctt_send_idx == userInfo.idx ?
            ...
            <View style={{flexDirection:'row',flex:1}}>
              <View style={{flex:1}}>
                <Image source={
                  item.mt_image1 == null? require('../../../assets/img/img_profile.png'):{uri:'http://ec2-13-125-251-68.ap-northeast-2.compute.amazonaws.com:4000/uploads/'+item.mt_image1}} 
          ...
          {item.ctt_send_idx == userInfo.idx ?
            <View style={{alignItems:'flex-end',marginBottom:20}}>
              {/* <View style={{backgroundColor:colors.GREEN_COLOR_2,paddingVertical:10,paddingHorizontal:20,borderRadius:150,borderTopRightRadius:0,maxWidth:'50%'}}> */}
              <Image source={{uri:'http://ec2-13-125-251-68.ap-northeast-2.compute.amazonaws.com:4000/uploads/'+item.ctt_file1}} style={{width:135,height:135,borderRadius:6}} />
              {/* </View> */}
              <Text style={[style.text_re,{marginTop:5,fontSize:12,color:colors.GRAY_COLOR_2}]}>{t('오후')} {item.ctt_sdate}</Text>
            </View>
          :
          <View style={{alignItems:'flex-start',marginBottom:20,flex:1,}}>
            <View style={{flexDirection:'row',flex:1}}>
              ...
              <View style={{marginLeft:20,marginTop:5 ,flex:8}}>
                ...
                <Image source={{uri:'http://ec2-13-125-251-68.ap-northeast-2.compute.amazonaws.com:4000/uploads/'+item.ctt_file1}} style={{width:42,height:42}} borderRadius={6}/>
                </View>
                <Text style={[style.text_re,{marginTop:5,fontSize:12,color:colors.GRAY_COLOR_2}]}>{t('오후')} {item.ctt_sdate}</Text>
              </View>
            </View>
