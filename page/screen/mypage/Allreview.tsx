...
export default function AllreView() {
  ...
  const userInfo = useSelector((state:any) => state.userInfo);
    ...
    const NaviProceeding = () => {
        return(
            <ReviewBuy  items={reviewbuy} ReviewCount={reviewbuy.length} Remove={RemoveOnsale} rt_type={rt_type_buy}/>
        )
    }

    const NaviEndEvent = () => {
        return(
            <ReviewSale items={reviewsale} ReviewCount={reviewsale.length} Remove={RemoveComplete} rt_type={rt_type_sale}/>
        )
    }
