...
const SaledList_Complete = ({ items, ReviewCount, Remove, getOnsaleData, getCompleteData }: any) => {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }}>
      <FlatList data={items}
        ...
        renderItem={({ item }) => (
          <ProductSaledList item={item} Remove={Remove} Modify={Modify} getOnsaleData={getOnsaleData} getCompleteData={getCompleteData} />
        )}
      />
