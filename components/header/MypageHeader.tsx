...
import { MypageHeaderType } from '../types/componentType';


export const MypageHeader = ({title}:MypageHeaderType) => {
    ...
    return(
       <View style={[style.header_,{backgroundColor:'#ffffff'}]}>            
            ...
            <TouchableOpacity onPress={MypageSetting} style={[{position:'absolute',right:0,width:50,height:50,justifyContent:'center'}]}>
